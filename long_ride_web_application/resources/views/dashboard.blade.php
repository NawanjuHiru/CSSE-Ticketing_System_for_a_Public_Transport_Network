...
@section('content')
        ...
        <div class="col-sm-3">
            <div class="card h-100 border-warning hover scard">
                <div class="card-body text-center">
                    ...
                    <h5 class="card-title text-warning">Passengers </h5>
                    <hr class="bg-warning" />
                    <a href="/passenger/index" type="button" id="" class="modal-effect btn btn-warning">View
                    </a>
                </div>
            </div>
        </div>
        <div class="col-sm-3">
            <div class="card h-100 border-success hover scard">
                <div class="card-body text-center">
                    ...
                    <h5 class="card-title text-success">Routes </h5>
                    <hr class="bg-success" />
                    <a href="/route/index" type="button" id="" class="modal-effect btn btn-success">View
                    </a>
                </div>
            </div>
        </div>
        <div class="col-sm-3">
            <div class="card h-100 border-danger hover scard">
                <div class="card-body text-center ">
                    ...
                    <h5 class="card-title text-danger">Cards</h5>
                    <hr class="bg-danger" />
                    <a href="/card/index" type="button" id="" class="modal-effect btn btn-danger">View
                    </a>
                </div>
            </div>
        </div>
        <div class="col-sm-3">
            <div class="card h-100 border-primary hover scard">
                <div class="card-body text-center">
                    ...
                    <h5 class="card-title text-primary">Inspectors </h5>
                    <hr class="bg-primary" />
                    <a class="modal-effect btn btn-primary" id="" data-effect="effect-fall"
                        href="/ticketInspector/index">View</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">Generate Ticket Inspector </h6><button aria-label="Close" class="close"
    ...
    <div class="modal effect-fall" id="passengerModal">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">Generate Passenger </h6><button aria-label="Close" class="close"
                        data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
                </div>
    ...
    <div class="modal effect-fall" id="routeModal">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">Generate Route </h6><button aria-label="Close" class="close"
                        data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
                </div>
    ...
    <div class="modal effect-fall" id="vehicleModal">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">Generate Vehicle </h6><button aria-label="Close" class="close"
                        data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
                </div>
