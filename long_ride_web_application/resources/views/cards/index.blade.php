    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card custom-card">
                <div class="card-body">
                    <h6 class="card-title mb-3">Long Ride Cards</h6>
                    <form method="POST" class="login-form" id="form_id">
                        <div class="row">
                            <div class="col-md-12 text-right  mb-3">
                                <a href="{{ route('card_view', ['action' => 'add', 'id' => '']) }}" type="button"
                                    data-toggle="tooltip-primary" data-placement="top" title="Add a new card"
                                    class="btn btn-success text-right text-white"> + New Card Type</a>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
        ...
        $(document).on('click', '.tog', function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        if (status == 'Yes') {
                            $('*[data-routeid="' + routeId + '"]').closest("tr td div").toggleClass(
                                'on');
                        } else {
                            $('*[data-routeid="' + routeId + '"]').closest("tr td div").toggleClass(
                                'on');
